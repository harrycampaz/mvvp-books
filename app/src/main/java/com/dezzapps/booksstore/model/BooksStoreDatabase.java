...
public abstract class BooksStoreDatabase extends RoomDatabase {

    public  abstract  CategoryDAO categoryDAO();
    public abstract  BookDAO bookDAO();


    private static BooksStoreDatabase instance;

    public static synchronized BooksStoreDatabase getInstance(Context context){
        if(instance == null){
            instance = Room.databaseBuilder(context.getApplicationContext(),
                    BooksStoreDatabase.class, "books_store_database")
    ...
    private  static  class  InitialDataAsyncTask extends AsyncTask <Void, Void, Void>{
        ...
        public InitialDataAsyncTask(BooksStoreDatabase booksStoreDatabase){
